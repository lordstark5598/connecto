  ...
  return (
    <div className='fixed inset-0 z-110 min-h-screen- bg-black/80 backdrop-blur text-white flex items-center justify-center p-4'>
        <div className='w-full max-w-md'>
            ...
            <div style={{backgroundColor:background}} className="rounded-lg h-96 flex items-center justify-center relative">
                {mode==='text' &&(
            ...
            <button onClick={()=>toast.promise(handleCreateStory(), {loading: 'Posting ..',success: <p>Posted Successfully</p>, error:'Something went wrong..!'})} className='flex items-center justify-center gap-2 text-white py-3 mt-4 w-full rounded bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition cursor-pointer'>
                <Sparkle size={18} /> Post Story
            </button>
        </div>
